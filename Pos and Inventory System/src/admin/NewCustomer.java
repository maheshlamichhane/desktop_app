...
public class NewCustomer extends JFrame
{
    ...
    public NewCustomer(String name)
    {
	  ...
	  JLabel province=new JLabel("State:");
	  ...
	  zipcode_textbox.addKeyListener(new KeyAdapter() {
	         public void keyPressed(KeyEvent ke) {
	            String value =  zipcode_textbox.getText();
	            int l = value.length();
	            if (ke.getKeyChar() >= '0' && ke.getKeyChar() <= '9' || ke.getKeyCode()==KeyEvent.VK_BACK_SPACE || ke.getKeyCode()==KeyEvent.VK_ENTER) {
	            	 zipcode_textbox.setEditable(true);
	            } else {
	            	JOptionPane.showMessageDialog(null, "please enter only numeric data");
	               String orginal= zipcode_textbox.getText();
	               int len=orginal.length();
	               String org=orginal.substring(0,len-1);
	               zipcode_textbox.setText(org);
	  ...
	  contactnumber_textbox.addKeyListener(new KeyAdapter() {
	         public void keyPressed(KeyEvent ke) {
	            String value =  contactnumber_textbox.getText();
	            int l = value.length();
	            if (ke.getKeyChar() >= '0' && ke.getKeyChar() <= '9' || ke.getKeyCode()==KeyEvent.VK_BACK_SPACE || ke.getKeyCode()==KeyEvent.VK_ENTER) {
	            	 contactnumber_textbox.setEditable(true);
	            } else {
	            	JOptionPane.showMessageDialog(null, "please enter only numeric data");
	               String orginal= contactnumber_textbox.getText();
	               int len=orginal.length();
	               String org=orginal.substring(0,len-1);
	               contactnumber_textbox.setText(org);
	  ...
	  save.addActionListener(new ActionListener()
	  {
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			else
			{
				...
				else if(province_textbox.getText().length()>1)
				{
					JOptionPane.showMessageDialog(null, "Privinance  must have maximum 1 characters");
				...
				{
					JOptionPane.showMessageDialog(null, "Stock Field  must have maximum 40 characters");
				...
				int province=Integer.parseInt(province_textbox.getText());
    ...
    {
    	NewCustomer customer=new NewCustomer(null);
    }
