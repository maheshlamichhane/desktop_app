...
public class NewItem extends JFrame
{
	...
	public NewItem(String name)
	{
		 Border raisedetched = BorderFactory.createEtchedBorder(EtchedBorder.RAISED);
		  ...
		  String nam[]={"Select Any","Book","Diary","Copy","Sports","Pen","Gifts",""};
		  ...
		  discount.setBounds(340,303,70,20);
		  JTextField discount_textbox=new JTextField();
		  discount_textbox.setBounds(410,300,225,25);
		  discount_textbox.setBorder(loweredbevel);
		  discount_textbox.addFocusListener(new FocusListener(){
		  ...
		  stocks.setBounds(340,343,70,20);
		  JTextField stocks_textbox=new JTextField();
		  stocks_textbox.setBounds(410,340,225,25);
		  ...
		  add.addActionListener(new ActionListener()
		  {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else if(discount_textbox.getText().equals(""))
				{
					JOptionPane.showMessageDialog(null, "Discount Field can't be empty");
					stocks_textbox.setBackground(Color.RED);
				}
				...
				else
				{
					...
					{
						JOptionPane.showMessageDialog(null, "Item Name must have maximum 30 characters");
						itemname_textbox.setBackground(Color.yellow);
					}
					else if(category_textbox.getSelectedItem().toString().length()>25)
					{
						JOptionPane.showMessageDialog(null, "Category Field  must have maximum 30 characters");
						category_textbox.setBackground(Color.yellow);
					}
					else if(descriptionval_textbox.getText().length()>25)
					{
						JOptionPane.showMessageDialog(null, "Description Field  must have maximum 50 characters");
					...
					else if(discount_textbox.getText().length()>10)
					{
						JOptionPane.showMessageDialog(null, "Discount Field  must have maximum 10 characters");
						stocks_textbox.setBackground(Color.yellow);
					}
					else
					{
					...
					try
					{
						...
						pst.setDouble(5,Double.parseDouble(price_textbox.getText()));
						pst.setInt(6, stock);
						pst.setDouble(7, Double.parseDouble(discount_textbox.getText()));
		  ...
		  discount_textbox.addKeyListener(new KeyListener()
		  {
