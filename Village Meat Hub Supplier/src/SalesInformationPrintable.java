...
public class SalesInformationPrintable  implements Printable, ImageObserver 
{
	...
	public SalesInformationPrintable(String bill)
	{
		this.bill=bill;
	}
	...
	public int print(Graphics graphics,PageFormat pageFormat,int pageIndex) throws PrinterException
       ...
       if(pageIndex==0)
       {
           ...
           try
           {
        	   ...
        	   PreparedStatement pst=con.prepareStatement("select item_name,category,price,quantity,total from sales_real");
